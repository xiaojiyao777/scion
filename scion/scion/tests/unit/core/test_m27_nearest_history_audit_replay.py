...
def test_m27_actual_context_routes_fixed_top1_then_accepts_read_and_cited_ref() -> None:
    fixture = _fixture()
...
def test_m27_actual_context_accepts_a_preemptive_top1_read_without_audit_trigger() -> (
    None
):
    fixture = _fixture()
    _research_input, _history, context = _provider_context(fixture)
