...
def available_cvrp_mechanisms() -> tuple[CvrpMechanismSpec, ...]:
    ...
    return default_cvrp_mechanisms() + (
        ...
        CvrpMechanismSpec(
            mechanism_id="adaptive_embedded_vns_cadence4",
            label="adaptive embedded VNS cadence 4",
            mechanism_family="candidate_probe",
            mechanism_slice="adaptive_embedded_vns_cadence4",
            description=(
                "Focused scheduler probe that keeps initial VNS and runs "
                "embedded VNS every fourth ALNS iteration, while still "
        ...
        CvrpMechanismSpec(
            mechanism_id="adaptive_embedded_vns_early8_cadence2",
            label="adaptive embedded VNS early-8 then cadence 2",
            mechanism_family="candidate_probe",
            mechanism_slice="adaptive_embedded_vns_early8_cadence2",
            description=(
                "Focused scheduler probe that keeps initial VNS, protects "
                "embedded VNS during the first eight ALNS iterations, then "
                "thins to cadence-2 while still polishing repaired candidates "
                "that improve current/best."
            ),
            overlays=("config_adaptive_embedded_vns_early8_cadence2",),
        ),
        CvrpMechanismSpec(
            mechanism_id="adaptive_embedded_vns_share60_cadence2",
            label="adaptive embedded VNS share-60 then cadence 2",
            mechanism_family="candidate_probe",
            mechanism_slice="adaptive_embedded_vns_share60_cadence2",
            description=(
                "Focused scheduler probe that keeps initial VNS and runs "
                "embedded VNS while its ALNS-loop runtime share is below 60%, "
