...
NEXT_REQUIRED_DIRECTION = (
    ...
    "Successor15 then found an active weak-positive construction branch, "
    "`granular_savings_seed_portfolio`, with CMT2/CMT4/M gains but below-MDE "
    "aggregate evidence and an X-n110 caveat. The next CVRP solver-design "
    "attempt should prefer same-mechanism follow-up on that active granular "
    "construction branch, unless it explicitly chooses a materially different "
...
REQUIRED_EVIDENCE = (
    ...
    (
        "prefer same-mechanism follow-up on active weak-positive "
        "granular_savings_seed_portfolio, or otherwise a materially different "
        ...
        "savings_seed_selection_probe were reviewed no-positive-at-MDE; "
...
MEASURABLE_OPPORTUNITY_CLASSES = (
    (
        ...
        "same-mechanism accepted objective delta; follow active weak-positive "
        "granular_savings_seed_portfolio before declaring it reviewed, and "
        "after reviewed savings_seed_selection_probe no-positive-at-MDE "
...
SUCCESSOR_PORTFOLIO_RULE = (
    ...
    "repeated it as an evidence-complete construction successor. The active "
    "granular_savings_seed_portfolio branch is weak-positive rather than "
    "reviewed/default-avoid, so the next CVRP slot should prefer a "
    "same-mechanism follow-up there or otherwise a non-reviewed portfolio "
    "attempt. Use "
