...
NEXT_REQUIRED_DIRECTION = (
    ...
    "adjacency-pair removal repair, load-compatible ruin/recreate, route-pair "
    "crossover repair, timewarp string removal, and savings seed selection and "
...
REQUIRED_EVIDENCE = (
    ...
    (
        ...
        "destroy/repair successors, reviewed route_pair_crossover_repair and "
        "timewarp_string_removal successor14 destroy/repair evidence, reviewed "
    ...
    (
        ...
        "load_compatible_ruin_recreate, route_pair_crossover_repair, "
        "timewarp_string_removal, and savings_seed_selection_probe were "
...
MEASURABLE_OPPORTUNITY_CLASSES = (
    ...
    (
        ...
        "farthest_noise_related_removal, polar_sweep_destroy_repair, and "
        "route_fragment_recombination_repair, adjacency_pair_removal_repair, "
        "load_compatible_ruin_recreate, route_pair_crossover_repair, and "
        "timewarp_string_removal no-positive-at-MDE results, require a "
        "destroy/repair causal path distinct from those removal and repair paths"
    ),
    (
...
SUCCESSOR_PORTFOLIO_RULE = (
    ...
    "and load_compatible_ruin_recreate plus route_pair_crossover_repair and "
    "timewarp_string_removal have repeated it as destroy/repair successors, "
    "and savings_seed_selection_probe has repeated it as an "
