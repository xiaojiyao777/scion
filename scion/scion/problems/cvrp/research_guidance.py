...
NEXT_REQUIRED_DIRECTION = (
    ...
    "[-20.25, 0.5], CMT2 -80.0, CMT4 -33.5), parking the branch. The next "
    "CVRP solver-design attempt should either clean-fork to a materially "
    "different problem-owned causal path or repair seed_post_optimization_selector "
    "activation with explicit pre-protocol and formal mechanism evidence; "
    "do not repeat unchanged granular_savings_seed_portfolio or "
    "exact_short_route_polish variants. "
    ...
    "string removal, and savings seed selection and carries direct per-case "
    "objective-effect evidence."
)
CURRENT_QUESTION = (
    ...
    "successors, including granular seed-portfolio and exact short-route "
    "polish follow-ups, were reviewed without positive-at-MDE solver effect, "
    "can a materially different CVRP-owned construction, destroy/repair, or "
...
REQUIRED_EVIDENCE = (
    ...
    (
        ...
        "exact_short_route_polish successor18b evidence, and prior "
        "default-avoid families before spending another branch slot"
    ),
    (
        "do not continue unchanged granular_savings_seed_portfolio or "
        "exact_short_route_polish after successor18b parked the branch; "
        "prefer a clean fork to a materially different "
        "destroy_repair_selection, distinct construction seed-selection, or "
        "another non-reviewed CVRP-owned causal path, or repair the "
        "twice-inactive seed_post_optimization_selector activation path with "
        "explicit pre-protocol and formal mechanism evidence, after "
...
MEASURABLE_OPPORTUNITY_CLASSES = (
    (
        ...
        "same-mechanism accepted objective delta; successor18b moved "
        ...
        "continue unchanged variants; do not repeat seed_post_optimization_selector "
        "after twice-missing activation unless repairing activation wiring "
        "with explicit pre-protocol and formal mechanism evidence; after "
        "reviewed savings_seed_selection_probe no-positive-at-MDE evidence, "
        "require any new construction path to be causally distinct"
    ),
    (
        ...
        "route_fragment_recombination_repair, adjacency_pair_removal_repair, "
        "load_compatible_ruin_recreate, load_complement_pair_removal, "
        "route_pair_crossover_repair, and timewarp_string_removal "
        "no-positive-at-MDE results, require a destroy/repair causal path "
        "distinct from those removal and repair paths"
    ),
    (
...
SUCCESSOR_PORTFOLIO_RULE = (
    ...
    "bounded_intra_route_3opt plus bounded_ejection_chain_relocate have "
    ...
    "route_pair_crossover_repair, and timewarp_string_removal have repeated it "
    "as destroy/repair successors, and savings_seed_selection_probe plus "
    "granular_savings_seed_portfolio and exact_short_route_polish have "
    "repeated it as construction successors. "
    ...
    "repaired. The next CVRP slot should prefer a clean fork to a materially "
    "different non-reviewed portfolio attempt, or an activation repair for "
    "seed_post_optimization_selector with direct activation and "
    "objective-effect evidence. Use "
