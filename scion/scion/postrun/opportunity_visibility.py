...
def problem_opportunity_visibility_fingerprint(
    ...
    if not isinstance(prompt_manifest, Mapping) or not prompt_manifest:
        return {}
    section_status = _section_status(prompt_manifest, PROBLEM_OPPORTUNITY_SECTION)
    ledger_entry = _section_ledger_entry(prompt_manifest, PROBLEM_OPPORTUNITY_SECTION)
    ...
    return _drop_empty(
        {
            ...
            "context_prompt_key": metadata.get(
