...
class AgenticSessionOutputMixin:
    def _resolve_injected_output(
            ...
            return replace(
                ...
                split_manifest_hash=(
                    output.split_manifest_hash or request.split_manifest_hash
                ),
                seed_ledger_hash=output.seed_ledger_hash or request.seed_ledger_hash,
                context_profile=output.context_profile or request.context_profile,
    ...
    def _persist(
            ...
            output = replace(
                ...
                context_profile=output.context_profile or state.context_profile,
