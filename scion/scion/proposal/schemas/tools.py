...
PATCH_TOOL: Dict[str, Any] = {
    ...
    "description": (
        ...
        "- Use edit_intent=full_file only for creates, deletes, or explicitly "
        "justified larger rewrites; include full_file_reason.\n"
...
FIX_TOOL: Dict[str, Any] = {
    ...
    "description": (
        ...
        "- Prefer exact_replace for a small repair; use full_file only for a "
        "larger rewrite and include full_file_reason.\n\n"
        "Common patterns:\n"
