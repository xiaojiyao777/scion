...
PATCH_TOOL: Dict[str, Any] = {
    ...
    "description": (
        ...
        "Usage:\n"
        "- Prefer edit_intent=exact_replace for small edits to existing files.\n"
        "- Use edit_intent=full_file only for creates, deletes, or complex rewrites.\n"
        "- For exact_replace provide source_digest, old_string, new_string, and replace_all.\n"
...
FIX_TOOL: Dict[str, Any] = {
    ...
    "description": (
        ...
        "- Prefer exact_replace for a small repair; use full_file when the corrected file is simpler.\n\n"
        "Common patterns:\n"
