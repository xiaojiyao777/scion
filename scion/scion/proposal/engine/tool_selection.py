...
_TOOL_SELECTION_SYSTEM_TEXT = (
    ...
    "When compact research signals, branch lesson usage requirements, material "
    "difference requirements, and target-intent/source anchors are already "
    "visible, do not reread broad context only to restate them; stop planning "
    "or inspect only the missing target/source fact.\n"
