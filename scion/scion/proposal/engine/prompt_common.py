    ...
    *,
    ...
    if preview_rejections:
        ...
        parts.append(
            ...
            "follow retry_payload.final_task and retry_payload.retry_rule exactly. "
            "For ordinary schema/accounting repair, preserve the protected "
            "identity and repair only schema/telemetry fields. For "
            "launch-focus required-mechanism repair, the listed "
            "required_mechanism_ids override the prior mechanism id and must be "
            "used exactly in mechanism_changes. The exact allowed telemetry "
            "template in this section is authoritative when present.\n\n"
