...
def _split_direct_v3_hypothesis_context(
    ...
    user_prompt = (
        ...
        "History is optional research evidence: you may read or search it, cite "
        "records you actually read, or ignore it when it is not useful. History "
        "does not prescribe a mechanism, action, target, or research direction. "
        "Identify an evidence-grounded bottleneck and propose one material change. "
