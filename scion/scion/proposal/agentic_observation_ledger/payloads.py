    ...
    return _drop_empty_dict(
        {
            ...
            "visible_text_chars": entry.get("visible_text_chars"),
            "visible_text_hash": entry.get("visible_text_hash"),
            "rendered_visibility_flag": entry.get("rendered_visibility_flag"),
