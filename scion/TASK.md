...
- Strict launch readiness for both current roots reports `static_ready=true`,
  ...
  true. The roots were prepared from WSL checkout `5ba9d56` after launch
...
- Current launch/runtime boundary: prepared roots must guard `scion/tools`,
  ...
  does not run `tools/check_gpt55_proxy.py` before the real campaign command.
  Older prepared roots before the preflightpos roots above are not current
