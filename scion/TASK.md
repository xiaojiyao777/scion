...
10. **R57 provider-free expression seam complete:** commit `f537fed5` adds the
   ...
   no provider, canary, formal Protocol or Decision call ran, and no successor
   H/C experiment is preregistered, authorized or launched.
11. **S6 closeout:** only after retained CVRP improvement, run the full relevant
