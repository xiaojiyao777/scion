...
- Research-efficiency reports now include a report-only `research_continuity`
  ...
  visibility, and prompt signal density without exposing raw prompts,
...
- The next CVRP campaign is temporarily blocked by LLM infrastructure, not by
  ...
  after the research-continuity report metrics repair; current `f481f15`
  prepared roots were refreshed and pass static readiness. Report:
