...
- Strict launch readiness for both current roots reports `static_ready=true`,
  ...
  true. The roots were prepared from WSL checkout `96d56d5` after launch
  ...
  marker checks began ignoring comment-only markers.
