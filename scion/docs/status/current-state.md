...
```bash
bash /home/xjy-ubuntu/research/scion-experiments/v04-wh-v2-a4b5317-promptdistill-6r-gpt55-20260620T232546Z-claw/run.sh
```
...
```bash
bash /home/xjy-ubuntu/research/scion-experiments/v04-cvrp-twoopt-a4b5317-promptdistill-resume-4r-gpt55-20260620T232559Z-claw/run.sh
```
...
Generated on WSL at launch-authoritative prepared runtime commit `a4b53173`;
the corresponding server repair commit is `75dd756e`. Local mirrors
...
- Warehouse:
  `/home/xjy-ubuntu/research/scion-experiments/v04-wh-v2-a4b5317-promptdistill-6r-gpt55-20260620T232546Z-claw`
- CVRP:
  `/home/xjy-ubuntu/research/scion-experiments/v04-cvrp-twoopt-a4b5317-promptdistill-resume-4r-gpt55-20260620T232559Z-claw`
...
- Runtime guard status: `runtime_guard_status=ok`,
  `prepared_runtime_commit=a4b53173`, and either
