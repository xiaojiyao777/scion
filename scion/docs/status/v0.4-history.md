...
can remain unexecuted because `CampaignLoop` stops at `max_rounds` and drains
only fresh-runtime replay. The next CVRP follow-up should add a bounded
validation-drain or reserved-validation-round mechanism before the formal
12/16-round campaign.
