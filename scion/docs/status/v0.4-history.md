...
Phase 3 remains open. Current problem specs declare calibration references such
as `formal/calibration/aa_noise_floor.json`, but the corresponding installed
artifacts are still missing. The next repair must install or reference
