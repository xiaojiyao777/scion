...
and max two concurrent cells with a 600s stagger. An earlier root ending
`T162506Z` was stopped after an immediate rep01 failure caused by server
absolute paths in the warehouse problem/split inputs.
