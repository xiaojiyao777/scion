...
After the current warehouse compact-baseline governance ON/OFF run, add a
CVRP/VRP baseline-strength contrast for the hypothesis that the current strong
