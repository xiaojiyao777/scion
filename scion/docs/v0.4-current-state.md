...
- CVRP formal research surface may need to expose baseline search policy,
  ...
  only post-baseline registry operators. The 2026-05-05 short run produced
  complete evidence but 96/96 generated-operator attempts were no-op after the
  strong `vrp/src` baseline.
